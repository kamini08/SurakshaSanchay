  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
        <CardDataStats title="Total items" total="2,345" rate="1.43%" levelUp>
          <svg
        ...
        <CardDataStats title="Items issued" total="1360" rate="4.35%" levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
        ...
        <CardDataStats title="items lost" total="122" rate="1.2%" levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="22"
