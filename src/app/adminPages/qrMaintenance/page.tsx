...
import QRScanner from "../../scanQR/QRScanner";
import ResultDisplay from "../../scanQR/ResultDisplay";
import ScanHistory from "../../scanQR/ScanHistory";
import ResultDisplayQr from "./ResultDisplayQr";
    ...
    <div className="mx-auto w-auto p-4 md:p-6 2xl:p-10">
      <div className="min-h-screen bg-white p-6 text-black dark:bg-boxdark dark:text-white">
        <div className="mx-auto max-w-2xl">
          ...
          {scanResult && (
            <div className="mb-6 rounded-sm border bg-white p-6 text-sm font-medium text-black shadow-default dark:border-strokedark dark:bg-boxdark dark:text-white">
              <ResultDisplayQr result={scanResult} onClear={handleClear} />
            </div>
          )}
