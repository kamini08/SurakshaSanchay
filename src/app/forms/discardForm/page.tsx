...
//                   <input
//                     type="text"
//                     placeholder="Item Name (for display)"
//                     disabled
//                     className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition dark:border-form-strokedark dark:bg-form-input dark:text-white"
//                   />
//                 </div>
...
//                     className="mr-2"
//                   />
//                   <span className="text-black dark:text-white">Yes</span><br></br>
//                   <label className="mb-3 block text-sm font-medium text-black dark:text-white">
...
//                     type="file"
//                     multiple
//                     className="w-full cursor-pointer rounded-lg border-[1.5px] border-stroke bg-transparent outline-none transition file:mr-5 file:cursor-pointer file:border-0 file:border-r file:border-solid file:border-stroke file:bg-whiter file:px-5 file:py-3 file:hover:bg-primary file:hover:bg-opacity-10 focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:file:border-form-strokedark dark:file:bg-white/30 dark:file:text-white dark:focus:border-primary"
//                   />
//                 </div>
//               </div>
//             </div>
...
//                 <button
//                   type="submit"
//                   className="rounded-lg bg-primary px-6 py-3 text-white transition hover:bg-opacity-90 dark:bg-secondary dark:hover:bg-opacity-80"
//                 >
