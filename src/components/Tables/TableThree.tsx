...
//             setPackageData(data);
//           } else {
//             // Fallback to default data if no data is returned from the API
//             setPackageData(defaultData);
//           }
//         } else {
//           console.error("Failed to fetch data");
//           setPackageData(defaultData); // Fallback to default data on failure
//         }
//       } catch (error) {
//         console.error("Error fetching data:", error);
//         setPackageData(defaultData); // Fallback to default data on error
//       } finally {
//         setLoading(false);
//       }
//     };
...
//     setEditedRow((prev) => ({
//       ...prev,
//       [name]: isNaN(Number(value)) ? value : Number(value), // Convert numeric fields to numbers
//     }));
//   };
...
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.issuedTo}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.quantity}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.location}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.condition}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.acquisitionDate}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.expiryDate}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.price}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.supplier}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.assignedTo}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.returnDate}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.lastInspectionDate}</td>
//                   <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">{item.maintenanceSchedule}</td>
