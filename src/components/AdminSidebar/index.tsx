    ...
    menuItems: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Add Inventory Item", route: "/admin/addInventory" },
          { label: "Inventory Usage Insight", route: "/admin/viewInventory" },
          { label: "Inventory Overview", route: "/admin/inventoryOverview" },
        ],
      },
...
>
  ...
  <line x1="6" y1="14" x2="16" y2="14" stroke="currentColor" stroke-width="1.5" />
        ...
        children: [
          ...
          { label: "Approved/Denied Request", route: "/forms/approvedDeniedrequest" },
  ...
  <path d="M10 18H14"/>
        ...
        route: "#",
        children: [
          { label: "View Monthly Report", route: "/admin/monthlyReport" },
          { label: "Audit Logs", route: "/admin/auditTrail" }
        ]
      },
