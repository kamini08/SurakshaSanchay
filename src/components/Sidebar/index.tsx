    ...
    menuItems: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            label: "Accept User Maintenance Request",
            route: "/forms/acceptMaintenanceRequest",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        label: "Assest Tracking",
        route: "/forms/assetTracking",
      },

      {
        ...
        route: "#",
        children: [{ label: "  Register User", route: "/registerUser" }],
      },
    ],
  },
];
